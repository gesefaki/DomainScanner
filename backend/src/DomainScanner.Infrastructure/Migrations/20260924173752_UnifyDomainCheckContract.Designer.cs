...
namespace DomainScanner.Infrastructure.Migrations
{
    ...
    [Migration("20260924173752_UnifyDomainCheckContract")]
    partial class UnifyDomainCheckContract
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DomainScanner.Domain.Entities.DomainCheckResult", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("Redirects")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<DateTime?>("TlsCertificateExpiresAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool?>("TlsHasValidationErrors")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("DomainId", "CreatedAt", "Id");
            ...
            modelBuilder.Entity("DomainScanner.Domain.Entities.DomainEntity", b =>
                {
                    ...
                    b.HasIndex("MonitoringEnabled", "UpdatedAt");
